...
const DEFAULT_ROOMS = {
  "Studio A":      { address: "",     locationName: "",    gateCode: "",     accessNote: "", description: "28' x 25' (8.5m x 7.6m) — stage 28' x 16' (8.5m x 4.8m) with hardwood floors\n20 amp breakers throughout\nPrivate restroom\nBehringer X32 digital console, QSC side fills, floor monitors, drum fill\nPhotos: matesinc.com",                                                       calendarId: "REPLACE_WITH_STUDIO_A_CALENDAR_ID",      hourly: null, daily: null },
  "Studio B":      { address: "",     locationName: "",    gateCode: "",     accessNote: "", description: "28' x 25' (8.5m x 7.6m) — stage 28' x 16' (8.5m x 4.8m) with hardwood floors\n20 amp breakers throughout\nPrivate restroom\nBehringer X32 digital console, QSC side fills, floor monitors, drum fill\nPhotos: matesinc.com",                                                       calendarId: "REPLACE_WITH_STUDIO_B_CALENDAR_ID",      hourly: null, daily: null },
  "Stage C":       { address: "",     locationName: "",    gateCode: "",     accessNote: "", description: "50' x 60' (15.24m x 18.3m) — stage 50' x 24'\n3-phase power, 100A per leg with tails, 20 & 30 amp breakers throughout\nMidas M32 digital console, LA Acoustics side fills, QSC K12 floor monitors and drum fill\nFOH room, private lounge, production office, two private restrooms, private fridge & coffee area\nPhotos: matesinc.com",                                                       calendarId: "REPLACE_WITH_STAGE_C_CALENDAR_ID",       hourly: null, daily: null },
  "Chandler Room": { address: "",     locationName: "",    gateCode: "",     accessNote: "", description: "Live room 23' x 19' (7m x 5.8m), control room 16' x 14' (4.9m x 4.25m)\nBehringer X32 digital console, QSC side fills, floor monitors, drum fill\nTwo private restrooms\nPhotos: matesinc.com",                                                       calendarId: "REPLACE_WITH_CHANDLER_ROOM_CALENDAR_ID", hourly: null, daily: null },
  "Gold Room":     { address: "",  locationName: "",  gateCode: "", accessNote: "This location has a gated entrance. Use the gate code below upon arrival.", description: "25' x 32' (7.6m x 9.8m)\n20 amp breakers throughout\nBehringer X32 digital console, QSC side fills, floor monitors, drum fill\nPhotos: matesinc.com", calendarId: "REPLACE_WITH_GOLD_ROOM_CALENDAR_ID",     hourly: null, daily: null },
  "Chino Room":    { address: "",  locationName: "",  gateCode: "", accessNote: "This location has a gated entrance. Use the gate code below upon arrival.", description: "38' x 24' (11.6m x 7.3m)\n3-phase power, 100A per leg with tails, 20 & 30 amp breakers throughout\nMidas M32 digital console, JBL side fills, QSC K12 floor monitors, QSC drum fill\nPrivate lounge, private fridge\nPhotos: matesinc.com", calendarId: "REPLACE_WITH_CHINO_ROOM_CALENDAR_ID",    hourly: null, daily: null },
  "Stage D":       { address: "",  locationName: "",  gateCode: "", accessNote: "This location has a gated entrance. Use the gate code below upon arrival.", description: "Main room 40' x 38' (12.2m x 11.5m)\n3-phase power, 100A per leg with tails, 20 amp outlets throughout\nMidas M32 digital console, JBL side fills, QSC K12 floor monitors and drum fill\nFOH room, private lounge, production office, two private restrooms, private fridge & coffee area\nPhotos: matesinc.com", calendarId: "REPLACE_WITH_STAGE_D_CALENDAR_ID",       hourly: null, daily: null },
  "Stage West":    { address: "",        locationName: "", gateCode: "",     accessNote: "", description: "60' x 50' x 11.5' (18.2m x 15.2m)\n3-phase power, 100A with 20 & 30 amp breakers throughout\nMeyer side fills\nPrivate production office, lounge & restrooms, 3-position dock-high semi load-in\nPhotos: matesinc.com",                                                       calendarId: "REPLACE_WITH_STAGE_WEST_CALENDAR_ID",    hourly: null, daily: null },
};
